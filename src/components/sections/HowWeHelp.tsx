...
import { HOW_WE_HELP } from '@/lib/constants';
    ...
    <section className="section-padding">
      <Container>
        <SectionHeading
          ...
          subtitle="From initial program research to final transaction coordination, Verdent provides organized, professional support that keeps your equipment purchase moving forward."
        />
